 ...
 * @author nejo
 */
public class Btn extends JButton implements MouseListener, MouseMotionListener{
    
    //Color para el fondo del boton
    
    private Color colorNormal = new Color(166,166,166);
    private Color colorPressed = new Color(214,217,223);   
    private Color colorHover = new Color(214,217,223);
    ...
    public Btn() {
        ...
        setFont(new java.awt.Font("MS Reference Sans Serif", 0, 11));
        setText("Botton");
